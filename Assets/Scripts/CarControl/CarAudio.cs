...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        public AudioMixerGroup audioMixer; //Send the car audio to the project mixer
        ...
        {        
            ...
            m_LowAccel.outputAudioMixerGroup = audioMixer;
            m_LowDecel.outputAudioMixerGroup = audioMixer;
            m_HighAccel.outputAudioMixerGroup = audioMixer;
            m_HighDecel.outputAudioMixerGroup = audioMixer;
        }
