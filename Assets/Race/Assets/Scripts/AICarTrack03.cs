...
public class AICarTrack03 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.tag == "AICar03")//If the 3rd AICar collider is detected (remember to set this tag in the AI car colliders when creating a new AI car)
        {
