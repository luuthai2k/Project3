...
public class TrigChk4 : MonoBehaviour
{
    //this script takes the count of the checkpoints and laps passed of AI bot 3
    ...
    //finally, add this script (TrigChk4) to the AICar03Position gameobject and you will need to create TrigChk5 for AICar04Position and so on...
    private void Start()
    {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            ChkManager.nDistP[3]/*position 3 in chk manager arrays stands for AI bot 3*/ = 0;//set the distance from checkpoint to 0 when crossing it
            ...
            {
                ChkManager.nChk[3]/*position 3 in chk manager arrays stands for AI bot 3*/ = nCheckpointNumber;
                CurrentChk += 1;
                NextChk += 1;
                ...
                {//that means that you passed all the checkpoints
                    startDis = true;
                    ChkManager.nLapsP[3]/*position 3 in chk manager arrays stands for AI bot 3*/ += 1;//and a lap is added to the lap counter
